...
TARGET_DIR="$HOME/SRCHUB"

# Directory of the executable
EXECUTABLE="$TARGET_DIR/SRC"

# Target link location
LINK_PATH="/data/data/com.termux/files/usr/bin/SRCHUB"
...
if [ ! -f "$EXECUTABLE" ]; then
    echo "Error: Executable not found in $EXECUTABLE. Ensure the SRCHUB executable is present in the dist/ folder."
    exit 1
fi
...
echo "Setup complete! You can now run the script from anywhere by typing 'SRC'."
